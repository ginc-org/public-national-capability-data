...
(() => {
  ...
  function injectStyles() {
    ...
    const css = `
      ...
      .ginc-cap-table th, .ginc-cap-table td { padding:6px 10px 6px 0; vertical-align:top; text-align:left; }
      .ginc-cap-table thead th { font-weight:600; border-bottom: 1px solid rgba(0,0,0,.06); }
